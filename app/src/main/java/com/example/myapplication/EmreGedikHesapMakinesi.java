...
public class EmreGedikHesapMakinesi extends Activity  {

    Button button_delete, button_karesiniAl, button_division, button_add, button_mult, button_subt, button_comma,button_kupunuAl, button_equal,num_1,num_2,num_3,num_4,num_5,num_6,num_7,num_8,num_9,num_0;
    TextView screen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_karesiniAl = findViewById(R.id.button_karesiniAl);
        button_kupunuAl = findViewById(R.id.button_kupunuAl);
        ...
        try {
            button_karesiniAl.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(!screen.getText().toString().equals(""))
                    {
        ...
        try {
            button_kupunuAl.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(!screen.getText().toString().equals(""))
                    {
